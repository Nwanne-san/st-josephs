  ...
  return (
    ...
    >
      <div className="h-screen  flex flex-col gap-8 justify-center">
        <div>
          <h4 className="leading-loose text-lg text-secondary font-bold uppercase">Caring for life</h4>
          <h1 className={`${Yeseva.className} text-5xl text-primary max-w-[520px]`}>
            Leading the way in Medical Excellence
          </h1>
        </div>
        <Button className="w-fit">Our services</Button>
      </div>
